...
?>
            ...
            <div class="status-summary">
                <span id="statusWaitingcheck" class="status waitingcheck">Waiting check: 2</span>
                <span id="statusWaitingRtp" class="status waitingryp">Waiting RTP: 2</span>
                <span id="statusInTime" class="status in-time">In time: 28</span>
                <span id="statusPriority" class="status priority">Priority: <?= $nbUrgent ?></span>
                <span id="statusRefused" class="status refused">Late: 2</span>
            </div>
    ...
    <table class="table1">
        <thead>
            <tr class='entete'>
                ...
                <th style="width:10%;"onclick="sortTable('reference')">ART COL <img src='/images/icones/arrow-down.svg' alt='Dashboard'></th>
                <th style="width:6%;" onclick="sortTable('made_in')">Made in <img src='/images/icones/arrow-down.svg' alt='Dashboard'></th>
                <th style="width:5%;">Supplier</th>
                <th style="width:15%;"onclick="sortTable('product_name')">Product name <img src='/images/icones/arrow-down.svg' alt='Dashboard'></th>
				...
				<th style="width:10%;" onclick="sortTable('date_validation_supplier')" class="TimRemRow">Time remaining <img src='/images/icones/arrow-down.svg' alt='Dashboard'></th>
				<th style="width:10%;" class="AddRow">Delivery address </th>
