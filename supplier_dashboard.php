    ...
    <?php 
    $data = [
        ['0133206','ART COL', 'Portugal','Buyer', 'Supplier', '09/01/2023','Waiting RTP', '4 days','Waiting confirmation'],
        ['0133206','ART COL', 'Portugal', 'Buyer','Supplier', '09/01/2023','In time', ' 6 days ','Waiting production'],
		['0133206','ART COL', 'Portugal','Buyer', 'Supplier', '09/01/2023','Waiting Check', '4 days','Waiting confirmation'],
        ['0133206','ART COL', 'Portugal','Buyer', 'Supplier', '09/01/2023','In time', ' - ','In production'],
		['0133206','ART COL', 'Portugal','Buyer', 'Supplier', '09/01/2023','Late', '4 days','Quality control'],
        ['0133206','ART COL', 'Portugal','Buyer', 'Supplier', '09/01/2023','Priority', ' -3 days ','Ready for shipping'],
		['0133206','ART COL', 'Portugal','Buyer', 'Supplier', '09/01/2023','Shipped', '4 days','Shipped'],
        ['0133206','ART COL', 'Portugal','Buyer', 'Supplier', '09/01/2023','Canceled', ' - ','Canceled'],
		['0133206','ART COL', 'Portugal','Buyer', 'Supplier', '09/01/2023','Waiting RTP', '4 days','Waiting confirmation'],
        ['0133206','ART COL', 'Portugal','Buyer', 'Supplier', '09/01/2023','In time', ' 6 days ','Waiting production'],
		['0133206','ART COL', 'Portugal','Buyer', 'Supplier', '09/01/2023','Waiting Check', '4 days','Waiting confirmation'],
        ['0133206','ART COL', 'Portugal','Buyer', 'Supplier', '09/01/2023','In time', ' - ','In production'],
    ...
    foreach ($data as $index => $row) {
        ...
        <tr class="main-row <?= $rowClass ?>" onclick="toggleDetails(this)">
            ...
            <td><?= $row[4] ?></td>
            <td><?= $row[5] ?></td>
			<td><span class="state <?= strtolower(str_replace(' ', '-', $row[6])) ?>"><?= $row[6] ?></span></td>
			<td class="TimRemRow"><?= $row[7] ?></td>
			<td class="AddRow">
