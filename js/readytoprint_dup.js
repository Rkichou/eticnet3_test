...
function openPopupAdRole() {
    document.getElementById("addrole").style.display = "flex";
}

// Fonction pour fermer la popup
function closePopupAdRole() {
    document.getElementById("addrole").style.display = "none";
}

// Fonction pour ouvrir la popup
function openPopupAdBrand() {
    document.getElementById("addbrand").style.display = "flex";
}

// Fonction pour fermer la popup
function closePopupAdBrand() {
    document.getElementById("addbrand").style.display = "none";
}

// Fonction pour ouvrir la popup
function openPopupAdCurrency() {
    document.getElementById("addcurrency").style.display = "flex";
}

// Fonction pour fermer la popup
function closePopupAdCurrency() {
    document.getElementById("addcurrency").style.display = "none";
}